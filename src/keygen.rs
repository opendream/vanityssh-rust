// src/keygen.rs
// Updated: 2025-04-22 12:18:45 by kengggg

use ed25519_dalek::Keypair;
use rand::rngs::OsRng;
use crate::error::Result; // Removed VanityError since it's not used

/// Generates an ed25519 key pair and returns the public key as a hex string.
